...
Werk de boom in **rondes**. De rand van het onderzochte gebied (kennisgrens) is elke beslissing waarvan de vereisten al zijn vastgesteld: de vragen die je _nu_ kunt stellen zonder te raden op antwoorden die je nog niet hebt gehoord. Vraag de hele kennisgrens in één ronde: nummer elke vraag en geef je aanbevolen antwoord. Wacht dan op de antwoorden van de gebruiker voor de volgende ronde.
...
Het vinden van _feiten_ is jouw taak, nooit die van de gebruiker. Wanneer een grensgebiedvraag een feit uit de omgeving nodig heeft (bestandssysteem, tools, enz.), stuur dan een subagent om het te vinden; Vraag de gebruiker niet om iets wat je zelf kunt opzoeken. Blokkeer er niet op: een lopende verkenning is een onopgeloste vereiste, dus alleen de vragen stroomafwaarts wachten op de subagent om te rapporteren; Vraag het nu aan de rest van de kennisgrens. De _beslissingen_ zijn die van de gebruiker: leg ze aan hen en wacht.

De sessie is afgelopen wanneer de grens leeg is: elke tak van de ontwerpboom wordt bezocht, niets wordt stilzwijgend aangenomen. Handel niet totdat de gebruiker bevestigt dat jullie tot een gedeeld begrip zijn gekomen.
